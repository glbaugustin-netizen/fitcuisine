  ...
  return (
    <main className="max-w-container mx-auto px-4 md:px-6 py-6 pb-24 md:pb-8">
      ...
      >
        ...
        >
          <Target size={38} strokeWidth={2} className="text-seche" aria-hidden="true" />
        </div>
        <div className="text-center">
          ...
          <p className="font-nunito text-text-secondary text-sm max-w-xs mx-auto leading-relaxed">
            Le dashboard de progression avec objectifs caloriques personnalisés arrivera dans l'étape 3.
          </p>
        </div>
        <span
          className="font-nunito font-bold text-xs border-2 border-border-strong text-white"
          style={{ backgroundColor: '#5AAD2F', borderRadius: '50px', padding: '6px 16px' }}
        >
          Étape 3
        </span>
      </div>
